...
public class BookingController : Controller
{
    ...
    public BookingController(IBookingService bookingService, IVillaService villaService, IVillaNumberService villaNumberService, UserManager<ApplicationUser> userManager)
    {
    ...
    public IActionResult BookingConfirmation(int bookingId)
    {
        ...
        if (bookingFromDb.Status == SD.StatusPending)
        {
            ...
            {
                _bookingService.UpdateStatus(bookingFromDb.Id, SD.StatusApproved, bookingFromDb.VillaNumber);
